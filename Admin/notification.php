...
<body>
    ...
    <div class="container mt-4">
        <h2 style="color: midnightblue;">Add New Notice</h2>
        <form method="post">
            <div class="form-group">
                <label for="new_notice">Notice:</label>
                <input type="text" id="new_notice" name="new_notice" class="form-control" style="width: 70%;" required>
            </div>
