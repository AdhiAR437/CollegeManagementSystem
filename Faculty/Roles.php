...
<form method="post">
    <div class="form-group">
        ...
        <select class="form-select" name="filename" id="filename" required>
            ...
            $timetablesDir = __DIR__ . '/../Admin/Facultyschedule';
    ...
    <button type="submit" name="submit" class="btn btn-primary">Load Roles</button>
</form>
...
function loadExcelFile($filename)
{
    ...
    $excelFile = __DIR__ . '/../Admin/Facultyschedule/' . $filename;
